...
part of 'profile_image_api.dart';
...
class _ProfileImageAPI implements ProfileImageAPI {
  _ProfileImageAPI(
    this._dio, {
    this.baseUrl,
  }) {
  ...
  Future<ProfileImage> getProfileImageBySchoolId(int schoolId) async {
    ...
    final _value = ProfileImage.fromJson(_result.data!);
    return _value;
  }
