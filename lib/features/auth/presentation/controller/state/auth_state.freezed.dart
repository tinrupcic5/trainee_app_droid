...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(UserLoginResponse user) authenticated,
    required TResult Function(MessageBody messageBody) registered,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(UserLoginResponse user)? authenticated,
    TResult? Function(MessageBody messageBody)? registered,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$AuthenticatedImplCopyWith<$Res> {
  ...
  @useResult
  $Res call({UserLoginResponse user});
}
...
abstract class _Authenticated implements AuthState {
  const factory _Authenticated(final UserLoginResponse user) =
      _$AuthenticatedImpl;

  UserLoginResponse get user;
  @JsonKey(ignore: true)
  _$$AuthenticatedImplCopyWith<_$AuthenticatedImpl> get copyWith =>
      throw _privateConstructorUsedError;
}
...
class _$RegisteredImpl implements _Registered {
  const _$RegisteredImpl(this.messageBody);
  ...
  @override
  String toString() {
    return 'AuthState.registered(messageBody: $messageBody)';
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return registered?.call(messageBody);
  }
...
abstract class _Registered implements AuthState {
  const factory _Registered(final MessageBody messageBody) = _$RegisteredImpl;
